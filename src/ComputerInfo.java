...
public class ComputerInfo implements ActionListener {
	...
	public static void main(String[] args) {
		ComputerInfo obj=new ComputerInfo();
	}
	...
	ComputerInfo(){
		...
		f1=new JFrame();
		f1.setSize(700,850);
		f1.setTitle("ComputerInfo");
		f1.setLayout(null);
		
		l1=new JLabel("COMPUTER");
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    if (source == b1) {
	        ...
	        if (tf1.getText().trim().isEmpty() ||
	        ...
	        } else if (tf6.getText().trim().length() != 10) {
	            JOptionPane.showMessageDialog(null, "Mobile number should be exactly 10 digits long.");
	        } else {
	            ...
	            InsertIntoDatabase.compdata(comp, model, ram, pro, cust, mobno, email, issue, charges);
	            ...
	            if (userSelection == JFileChooser.APPROVE_OPTION) {
	                ...
	                try {
	                    EmailSender.sendEmail(email, "Invoice and Details", "Here are your Computer details and invoice.", attachmentPath);

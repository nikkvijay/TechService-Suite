...
public class ScannerInfo implements ActionListener {
	...
	public static void main(String[] args) {
		ScannerInfo obj=new ScannerInfo();
	}
	...
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		 ...
		 if(obj==b1){ 
		        ...
		        InsertIntoDatabase.scannerdata(comp,model,resolution,type,cust,mobno,email,issue,charges);
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    DynamicBilling.generatePDF(comp,model,resolution,type,cust,mobno,email,issue,charges, attachmentPath);
                    JOptionPane.showMessageDialog(f1, "PDF saved: " + attachmentPath);

                    
                    try {
                        EmailSender.sendEmail(email, "Invoice and Details", "Here are your Scanner details and invoice.", attachmentPath);
